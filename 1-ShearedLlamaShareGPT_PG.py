...
convHistory = ''
modelfile = "models/sheared-llama-1.3b-sharegpt.Q5_K_M.gguf"
repetitionpenalty = 1.15
contextlength=32000
logfile = 'SLlama1.3_logs.txt'
print("loading model...")
...
with gr.Blocks(theme='Medguy/base2') as demo:   #theme=gr.themes.Glass()  #theme='remilia/Ghostly'
    ...
    with gr.Row(variant='compact'):
            ...
            with gr.Column(scale=10):
                ...
                + "<h1>🦙 Sheared-LLaMA-1.3B-ShareGPT - 32K context window</h2></center>")  
                with gr.Row():
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            - **Model**: 🦙 sheared-llama-1.3b-sharegpt.Q5_K_M.gguf
            - **Log File**: {logfile}
            """) 
